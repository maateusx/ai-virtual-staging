...
const STYLES = {
  furnish: { bg: 'bg-brand-pink', text: 'text-white', sub: 'text-white/80', before: '/landing/hero-antes.jpg', after: '/landing/hero-depois.jpg' },
  ...
  declutter: { bg: 'bg-brand-lavender', text: 'text-lp-ink', sub: 'text-lp-ink/70', before: '/landing/bagunca-antes.jpg', after: '/landing/bagunca-depois.jpg' },
  ...
  edit: { bg: 'bg-brand-ochre', text: 'text-lp-ink', sub: 'text-lp-ink/70', before: '/landing/furnish-before.jpg', after: '/landing/furnish-after.jpg' },
